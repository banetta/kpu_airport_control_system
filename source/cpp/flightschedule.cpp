...
{
	cout << setw(20) << airline << "\t" << setw(10) << destination << "\t" << setw(10) << seat[0] << "\t" << setw(10) << seat[1] << "\t" << setw(10) << seat[2] << "\t" << setw(10) << hour << shit << min << endl;
}
...
void FlightSchedule::takeoff_check(ControlTower &ct) 
{
	...
	if (set > 3 )
	{
		cout << setw(20) << "Delay in Airplain " << "Reason : bad weather. " << endl;
			min += 30;
	}
	else  if (set2 == 0)
	{
